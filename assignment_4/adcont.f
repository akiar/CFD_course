...
*
     ...
     C     BC(ID),DHUE(ID),DPDX(ID)
      ...
      INTEGER IB,IE,ID,I
      PRINT *, "I AP(1,1,I) AW(1,1,I) AE(1,1,I) 
...
*
     ...
     C             - BC(IB)
*
      PRINT *, IB, AP(1,1,IB), AW(1,1,IB), AE(1,1,IB), AP(1,2,IB),
...
*
     ...
     C              - BC(I)
*
        PRINT *, I, AP(1,1,I), AW(1,1,I), AE(1,1,I), AP(1,2,I),
...
*
      ...
      AW(1,2,IE) = -ACUW(IE)
      AE(1,2,IE) = -0.5*ACUE(IE)
*
      B(1,IE)    = - ACUW(IE)*(DHUE(IE-1)*(DPDX(IE-1)+DPDX(IE))/2)
     C             - BC(IE)
*
      PRINT *, IE, AP(1,1,IE), AW(1,1,IE), AE(1,1,IE), AP(1,2,IE),
