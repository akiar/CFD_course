...
*
      ATW(IB-1) = 0
      ATE(IB-1) = 0 ! DE(IB-1) ! QUESTION 3 CONDITION
      ATP(IB-1) = 1 ! HCONV * AREP(IB-1) + DE(IB-1) ! QUESTION 3 CONDITION
      BT(IB-1) = 373.15 ! HCONV * AREP(IB-1) * 323.15 ! QUESTION 3 CONDITION
*
*     End Node + 1
*      Node that has zero volume and only contains boundary information
*
...
*
      ATW(IE+1) = 0 ! DE(IE) ! QUESTION 3 CONDITION
      ATE(IE+1) = 0
      ATP(IE+1) = 1 ! HCONV * AREP(IE) + DE(IE) ! QUESTION 3 CONDITION
      BT(IE+1) = 373.15 ! HCONV * AREP(IE) * 313.15 ! QUESTION 3 CONDITION
*     
      RETURN
      END
